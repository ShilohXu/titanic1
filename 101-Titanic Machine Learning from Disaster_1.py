...
women_only_stats = data[0::, 4] == "female"  # This finds where all elements in the gender column that equals“female”
...
test_file = open('C:/Users/LZ-SANDY/Desktop/kaggle/101-Titanic Machine Learning from Disaster/test.csv')
test_file_object = csv.reader(test_file)
header = test_file_object.__next__()

prediction_file = open(
    "C:/Users/LZ-SANDY/Desktop/kaggle/101-Titanic Machine Learning from Disaster/genderbasedmodel.csv", "w", newline= '')
